...
def main():
    ...
    for i in range(num_epochs):
        ...
        torch.save(D.state_dict(), "./ckpt/esrgan_disc_ckpt.pth")
        if i == str(1200):
            torch.save(G.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_gene_1200.pth")
            torch.save(D.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_disc1200.pth")
        if i == str(1500):
            torch.save(G.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_gene_1500.pth")
            torch.save(D.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_disc_1500.pth")
        if i == str(2000):
            torch.save(G.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_gene_2000.pth")
            torch.save(D.state_dict(), "C:/Users/jeong/Documents/2023/senken1/dual_block/esrgan_disc_2000.pth")
            
        j = 0
    torch.save(G.state_dict(), "/content/gdrive/MyDrive/dlhacks/esrsan_gene_100.pth")
    torch.save(D.state_dict(), "/content/gdrive/MyDrive/dlhacks/esrsan_disc_100.pth")

if __name__ == "__main__":
>>>>>>> 1e4593961691c8092b72a9f9b7f269ea590f2e23
    main()